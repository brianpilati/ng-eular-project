 ...
 * 
 * <pre>
 * var bpEuler = angular.module('bpEuler', []);
 * bpEuler.run(function($templateCache) {
 ...
 *    angular.module('bpEuler', []).config(function($sceDelegateProvider) {
...
<file name="index.html">
  <div ng-controller="bpEulerController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("bpEulerController", function bpEulerController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('bpEulerWithSceDisabledbpEuler', []).config(function($sceProvider) {
